...
# # # #
# # # # a = int(input("add int a: "))
# # # # b = int(input("add int b: "))
# # # #
# # # # def add1 (a, b):
# # # #     return a + b
# # # #
...
# # #
# # #
# # # # print('Your World name is: ',first_name, last_name)
# # # # print('Your Korea name is: ',last_name, first_name)
# # #
